...
const AddEvent = ({
  ...
  const handleOnSubmit = async (event) => {
    ...
    if (!selectedService || !selectedTime) {
      toast.warning("Debes seleccionar un servicio y horario para continuar.");
      return;
    }
          ...
          <div className={styles.addEventTime}>
            ...
            >
              ...
              {horariosDisponibles.map((horario, index) => {
                ...
                return (
                  <option key={index} value={horario} disabled={isDisabled}>
                    {horario}
                  </option>
                );
              })}
          ...
          {selectedService && selectedServiceDetails && (
            <div className={styles.addEventDetail}>
              <p>
                ...
                {selectedServiceDetails.duration.slice(0, 5) + " hs"}
              </p>
              <p>
